...
| T8 Spindle | 1 | |  |  |
| M8 Linear Rod | 2 |  |  | 
| Coupling Motor <-> T8 Spindle | 1 | | |
| LCD display 16x2, Arduino Uno Header | 1 |  |  |  |
| Power supply (12V, 2A recommended) | 1 |  |  |  |
| Endstop Switch | 2 |  |  |  |
| Buzzer | 1 |  |  |  |

| Bearings | Qty | Description |
| --- | ---: | --- |
| LM8SUU | 2 | Linear bearing 8mm x 15mm x 17mm |
| T8 Flange Bearing | 1 | Flange bearing for T8 spindle |


| Screws | Qty |
| --- | ---: |
| M2 Flathead | 6 |
| M3 Countersunk Head | 16+ |
| M3 Flathead | 4 |
| M5 Flathead | 2 |


CAD Files created with FreeCAD, 3D Printed with PLA
